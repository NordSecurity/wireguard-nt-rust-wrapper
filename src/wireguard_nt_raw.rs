...
/// Wireguard-nt wrapper object, loads dll and accesses it's functions
...
/// Wireguard-nt wrapper, loads dll and gets accesses it's functions (implementation)
impl wireguard {
    /// Create a new wireguard interface from dll located at `path`
    ...
    /// Create a new wireguard interface from `library` object and load library functions
